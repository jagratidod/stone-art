...
const DreamTemplePage = () => {
  ...
  return (
    <div className="w-full min-h-screen bg-white">
      ...
      {/* THE TSA DIFFERENCE Comparison Table Section */}
      <section className="w-full py-12 md:py-16 lg:py-20 px-4 md:px-6 lg:px-8 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="overflow-x-auto">
            <table className="w-full border-collapse bg-white rounded-xl overflow-hidden shadow-2xl transform hover:scale-[1.01] transition-transform duration-300">
              <thead>
                <tr>
                  <th className="px-4 py-4 md:px-6 md:py-5 text-left text-sm md:text-base font-bold text-gray-800 uppercase border border-gray-200 bg-gray-50">
                    Feature
                  </th>
                  <th 
                    className="px-4 py-4 md:px-6 md:py-5 text-center text-sm md:text-base font-bold text-white uppercase border border-gray-200"
                    style={{ backgroundColor: '#8B7355' }}
                  >
                    Aslam Marble Suppliers
                  </th>
                  <th className="px-4 py-4 md:px-6 md:py-5 text-center text-sm md:text-base font-bold text-gray-800 uppercase border border-gray-200 bg-gray-50">
                    Local Vendors
                  </th>
                </tr>
              </thead>
              <tbody>
                ...
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="px-4 py-4 md:px-6 md:py-5 text-sm md:text-base text-gray-800 border border-gray-200 font-medium">
                    Artisanal Expertise
                  </td>
                  <td className="px-4 py-4 md:px-6 md:py-5 text-sm md:text-base text-gray-700 border border-gray-200">
                    <div className="flex items-center justify-center gap-2">
                      <svg className="w-5 h-5 flex-shrink-0" style={{ color: '#8B7355' }} fill="currentColor" viewBox="0 0 20 20">
